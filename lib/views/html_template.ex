defmodule ExHtmx.HTMLTemplate do
  ...
  > This method will wrap your render into lib/templates/application.html.heex to be able to insert the whole HTML.

  ## For example:

    ExHtmx.HTMLTemplate.render_file("repository/show.html.heex") #= This will be used as lib/templates/repository/show.html.heex
  """
  ...
  def render_file(view_path, assigns \\ []) do
    ...
    eval_file("lib/templates/application.html.heex", assigns: [content: template_content])
  end
